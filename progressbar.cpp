...
void Progressbar::tick() {
    ...
    std::chrono::minutes minutes_left = duration_cast<std::chrono::minutes>(time_left);
    std::chrono::seconds seconds_left = duration_cast<std::chrono::seconds>(time_left - minutes_left);
